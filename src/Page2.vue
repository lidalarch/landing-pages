<template>
    <div id="page2" class="container-fluid page">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                promo: {
                    title: 'Опрашивайте потребителей и клиентов с сервисом Анкетолог',
                    button: {
                        text: 'Создать опрос',
                ...
                blockMain: {
                    cards: [
                        {
                            text: 'Удобное программное обеспечение для проведения опроса и анализа результатов',
                ...
                blockCarousel: {
                    class: '',
                    title: 'Возможности анкет',
                    subtitle: 'Опрос потребителей',
                    text: `Онлайн-конструктор анкет с 18-ю типами вопросов и настройками внутренней логики
                    для создания опросов любой сложности`,
                    slides: [
                        {
                            id: 1,
                ...
                blockPluses: {
                    ...
                    cards: [
                        ...
                        },
                        {
                            ...
                            subtext: `в проведении опроса – мы можем отредактировать или подготовить анкету
                        ...
                        {
                            text: 'Верификация',
                            subtext: `опрашиваемых респондентов и полученных ответов – каждый ответ
